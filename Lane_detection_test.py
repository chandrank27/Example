...
def detect_edges(frame):
    lower_white = np.array([200, 200, 200], dtype = "uint8") # lower limit of blue color
    upper_white = np.array([255, 255, 255], dtype="uint8") # upper limit of blue color
    mask = cv2.inRange(frame,lower_white,upper_white) # this mask will filter out everything but blue
